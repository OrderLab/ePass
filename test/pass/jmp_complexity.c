...
void bpf_ir_jmp_complexity(struct bpf_ir_env *env, struct ir_function *fun, void *param) {
    ...
    array_for(pos2, jmp_insns) {
        ...
        struct ir_insn *load_insn =
            bpf_ir_create_load_insn(env, insn, bpf_ir_value_insn(alloc_insn), INSERT_FRONT);
        struct ir_insn *added =
            bpf_ir_create_bin_insn(env, load_insn, bpf_ir_value_insn(load_insn),
                                   bpf_ir_value_const32(1), IR_INSN_ADD, IR_ALU_64, INSERT_BACK);
        ...
        bpf_ir_create_jbin_insn(env, store_back, bpf_ir_value_insn(added),
                                bpf_ir_value_const32(100), new_bb, err_bb, IR_INSN_JGT, IR_ALU_64,
                                INSERT_BACK);
    }
