...
void add_counter(struct ir_function *fun) {
    ...
    array_for(pos, fun->reachable_bbs) {
        ...
        struct ir_insn *load_insn = create_load_insn(last, ir_value_insn(alloc_insn), INSERT_FRONT);
        ...
        struct ir_insn *added =
            create_bin_insn(load_insn, val1, val2, IR_INSN_ADD, IR_ALU_64, INSERT_BACK);
        ...
        create_jbin_insn(store_back, val1, val2, new_bb, err_bb, IR_INSN_JLT, IR_ALU_64,
                         INSERT_BACK);
