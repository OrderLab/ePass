...
struct pre_ir_insn store_reg_to_reg_mem(__u8 dst, __u8 src, __s16 offset,
					enum ir_vr_type type)
{
	struct pre_ir_insn insn;
	int size = vr_type_to_size(type);
...
struct pre_ir_insn store_const_to_reg_mem(__u8 dst, __s64 val, __s16 offset,
					  enum ir_vr_type type)
{
	struct pre_ir_insn insn;
	int size = vr_type_to_size(type);
...
struct pre_ir_insn alu_reg(__u8 dst, __u8 src, enum ir_alu_type type,
			   int opcode)
{
	struct pre_ir_insn insn;
	insn.dst_reg = dst;
...
struct pre_ir_insn alu_imm(__u8 dst, __s64 src, enum ir_alu_type type,
			   int opcode)
{
	struct pre_ir_insn insn;
	insn.dst_reg = dst;
...
struct pre_ir_insn cond_jmp_reg(__u8 dst, __u8 src, enum ir_alu_type type,
				int opcode)
{
	struct pre_ir_insn insn;
	insn.dst_reg = dst;
...
struct pre_ir_insn cond_jmp_imm(__u8 dst, __s64 src, enum ir_alu_type type,
				int opcode)
{
	struct pre_ir_insn insn;
	insn.dst_reg = dst;
